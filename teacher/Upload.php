...
if (isset($_REQUEST['submit'])) {
    ...
    if (in_array($filecheck1, $fileextstore1)) {
        ...
        $destinationfile1 = '../admin/NotesDetail/' . $filename1;
    ...
    if (
        ...
        Subject,Descrp,UploadedBy,UploadedOn,filename,Branch,Semester
      )
      values('$subject','$descrption','$teacher','$today','$destinationfile1','$branch','$semester')";
